...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Cat = __webpack_require__(70);
	...
	var API_PATH_CAT = "/api/cats";
	var API_PATH_CLOUDER = "/api/clowder";
	var AJAX = false;
	
	var Catrancher = function (_Component) {
	    _inherits(Catrancher, _Component);
	
	    function Catrancher() {
	        _classCallCheck(this, Catrancher);
	
	        var _this = _possibleConstructorReturn(this, (Catrancher.__proto__ || Object.getPrototypeOf(Catrancher)).apply(this, arguments));
	
	        _this.data = _data.pass.cats;
	
	        _this.attr_count = _this.data[0].length;
	        ...
	        _this.state = {
	            cats: _this.data,
	            clowders: _this.clowders,
	            popup: ''
	        };
	        _this.hideAlert = _this.hideAlert.bind(_this);
	        _this.setCat = _this.setCat.bind(_this);
	        _this.unSetCat = _this.unSetCat.bind(_this);
	        _this.updateClouder = _this.updateClouder.bind(_this);
	        _this.checkClouder = _this.checkClouder.bind(_this);
	        return _this;
	    }
	
	    _createClass(Catrancher, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            fetch(API_PATH_CAT).then(function (response) {
	        ...
	        key: 'clouderExists',
	        value: function clouderExists() {
	            var self = this;
	            var state = true;
	
	            this.clowders.map(function (clowder) {
	                if (!state) return;
	
	                clowder.forEach(function (success_cat) {
	                    self.selectCatList.forEach(function (selected_cat) {
	            ...
	            if (!state) {
	                this.setState({
	                    popup: _react2.default.createElement(_Alert2.default, { hideAlert: this.hideAlert, title: 'Sorry', content: 'this clouder already exist. please match diffrent cats' })
	                });
	            }
	        ...
	        key: 'checkClouder',
	        value: function checkClouder(cats, attr_count) {
	            if (AJAX) {
	                var self = this,
	                ...
	                fetch(url).then(function (response) {
	                    ...
	                    if (myBlob.valid && !self.clouderExists()) {
	                        self.setState({
	                            popup: _react2.default.createElement(_Alert2.default, { hideAlert: self.hideAlert, title: 'Congratulations', content: 'Those cats go along' })
	                        });
	                        self.updateClouder(false);
	                    } else {
	                        self.setState({
	                            popup: _react2.default.createElement(_Alert2.default, { hideAlert: self.hideAlert, title: 'Sorry', content: 'Those cats dont go along' })
	                        });
	                ...
	                for (var i = 0; i < attr_count; i++) {
	                    if (!this.checkAttr(cats[0].cat[i], cats[1].cat[i], cats[2].cat[i])) {
	                        this.setState({
	                            popup: _react2.default.createElement(_Alert2.default, { hideAlert: this.hideAlert, title: 'Sorry', content: 'Those cats dont go along' })
	                        });
	                        return false;
	                    }
	                }
	                ...
	                this.setState({
	                    popup: _react2.default.createElement(_Alert2.default, { hideAlert: this.hideAlert, title: 'Congratulations', content: 'Those cats go along' })
	                });
	        ...
	        key: 'checkAttr',
	        value: function checkAttr(a, b, c) {
	            return a === b && b === c || a != b && b != c && a != c;
	        }
	    }, {
	        key: 'updateClouder',
	        value: function updateClouder(state) {
	            if (state) {
	                this.selectCatList = [];
	                this.setState({
	        ...
	        key: 'setCat',
	        value: function setCat(cat, index) {
	            this.selectCatList.push({ cat: cat, index: index });
	        ...
	        key: 'unSetCat',
	        value: function unSetCat(index) {
	            var _this2 = this;
	
	            this.selectCatList.map(function (cat, pos) {
	                if (cat.index == index) {
	                    _this2.selectCatList.splice(pos, 1);
	                }
	            });
	        }
	    }, {
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'span',
	                        { className: 'floatl layout' },
	                        _react2.default.createElement(
	                            'ul',
	                            { className: 'list-wrapper' },
	                            this.state.cats.map(function (cat, index) {
	                                return _react2.default.createElement(_Cat2.default, { key: index, index: index, cat: cat, setCat: self.setCat, unSetCat: self.unSetCat, clear: self.state.clear });
	                            })
	                        )
	                    ),
	                    _react2.default.createElement(
	                        'span',
	                        { className: 'floatr layout' },
	                        this.state.clowders.map(function (cats, index) {
	                            var clouder = [];
	
	                            cats.map(function (cat) {
	                                clouder.push(_react2.default.createElement(_Cat2.default, { key: cats.index, cat: cat.cat }));
	                            });
	                            return _react2.default.createElement(
	                                'ul',
	                                { className: 'list-wrapper', key: index, data: index },
	                                clouder
	                            );
	                        })
	                    )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Cat = function (_Component) {
	    ...
	    function Cat() {
	        ...
	        var _this = _possibleConstructorReturn(this, (Cat.__proto__ || Object.getPrototypeOf(Cat)).apply(this, arguments));
	
	        _this.state = { selected: false };
	
	        _this.onCatSelected = _this.onCatSelected.bind(_this);
	        return _this;
	    }
	    ...
	    _createClass(Cat, [{
	        ...
	        key: 'onCatSelected',
	        value: function onCatSelected(e) {
	            var _this2 = this;
	
	            if (typeof this.props.setCat !== 'function') return;
	
	            var cat = e.currentTarget.getAttribute('data').split('');
	
	            if (this.state.selected) {
	                this.setState({ selected: false });
	                setTimeout(function () {
	                    _this2.props.unSetCat(_this2.props.index);
	                }, 0);
	            } else {
	                this.setState({ selected: true });
	                setTimeout(function () {
	                    _this2.props.setCat(cat, _this2.props.index);
	                }, 0);
	            }
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            var cat = this.props.cat.join(''),
	                selectedClass = this.state.selected ? "selected" : "";
	
	            return _react2.default.createElement(
	                'li',
	                { className: "list-item " + selectedClass, onClick: this.onCatSelected, data: cat },
	                _react2.default.createElement('img', { className: 'img', title: cat, src: "http://quantcats.herokuapp.com/static/cats/" + cat + ".png" })
	            );
	        }
	    }]);
	...
	var Alert = function (_Component) {
	    ...
	    _createClass(Alert, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                "div",
	                { className: "alert", onClick: this.props.hideAlert },
	                _react2.default.createElement(
	                    "div",
...
/***/ function(module, exports) {
	...
	var data = { "cats": [["2", "t", "t", "g"], ["2", "b", "t", "r"], ["3", "b", "s", "r"], ["2", "w", "r", "g"], ["1", "b", "r", "g"], ["3", "b", "t", "b"], ["3", "w", "r", "b"], ["3", "w", "s", "r"], ["1", "t", "r", "b"], ["1", "b", "r", "r"], ["2", "b", "r", "g"], ["2", "b", "s", "r"]] };
	var data_pass = { "cats": [["1", "t", "t", "g"], ["2", "w", "s", "b"], ["3", "b", "r", "r"], ["2", "t", "s", "g"], ["2", "b", "s", "r"], ["3", "t", "t", "g"], ["1", "b", "r", "r"]] };
	var data_fail = { "cats": [["1", "t", "t", "g"], ["1", "w", "s", "b"], ["3", "b", "r", "r"], ["1", "t", "s", "g"], ["2", "b", "s", "r"], ["1", "b", "s", "g"]] };
